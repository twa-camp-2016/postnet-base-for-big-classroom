'use strict';
var BarcodeToPostcode = require('../../src/core/BarcodeToPostcode.js');
var PostcodeToBarcode = require('../../src/core/PostcodeToBarcode.js');

describe("printBarcode test", function () {
    it("printBarcode test", function () {
        let postCode = '95713';
        let result = new PostcodeToBarcode().printBarcode(postCode);
...
describe("printPostCode test", function () {
    it("printPostCode test", function () {
        let barCode = '| :::|| :::|| :::|| :::|| :::|| :::|| :::|| :::|| :::|| :::|| |';
        let result = new BarcodeToPostcode().printPostCode(barCode);
